      ...
      <div className="p-4 sm:p-6">
        ...
        <div className="flex items-start gap-3 sm:gap-4">
          ...
          <p className="text-xs sm:text-sm text-text-accent leading-relaxed">
            O nosso site utiliza cookies para analisar o tráfego e melhorar a
            sua experiência de navegação. Utilizamos ferramentas como Google Ads
            e Meta Ads para medir o desempenho das nossas campanhas. Pode gerir
            ...
            <label className="flex items-start gap-3 cursor-default">
              ...
              <div>
                ...
                <span className="text-[10px] sm:text-xs text-text-muted leading-relaxed block mt-1">
                  Autorizo o tratamento de dados pessoais mínimos necessários
                  para navegar no site e aceder às páginas públicas, sem envio de
                  documentos. Inclui dados como endereço IP, cookies essenciais,
                  preferências de idioma e outras informações de navegação.
                </span>
              </div>
            </label>
          </div>
          ...
          <div className="mb-4 p-3 rounded-xl bg-bg-modal/50">
            <label className="flex items-start gap-3 cursor-pointer">
              ...
              <div>
                ...
                <span className="text-[10px] sm:text-xs text-text-muted leading-relaxed block mt-1">
                  Autorizo o tratamento dos meus dados pessoais e dos documentos
                  enviados, incluindo certidões e outros documentos necessários,
                  para análise do meu pedido e prestação dos serviços
                  solicitados. Inclui dados pessoais e documentos enviados pelo
                  utilizador para emissão de certidões ou outros serviços
                  administrativos.
                </span>
              </div>
            </label>
            ...
            <label className="flex items-start gap-3 cursor-pointer">
              ...
              <div>
                ...
                <span className="text-[10px] sm:text-xs text-text-muted leading-relaxed block mt-1">
                  ...
                  personalização de publicidade através de plataformas digitais,
                  incluindo serviços da Meta Platforms e da Google. Este
                  consentimento é totalmente opcional e pode ser retirado a
                  qualquer momento.
                </span>
              </div>
            </label>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <span className="text-[10px] sm:text-xs text-text-muted leading-relaxed block">
                    ...
                    navegar normalmente no site, mas alguns recursos permanecerão
                    desativados: envio de formulários e marketing.
                  </span>
                  ...
                  <ul className="text-[10px] sm:text-xs text-text-muted leading-relaxed list-disc pl-4 space-y-1">
                    <li>
                      <strong>Cookies essenciais:</strong> necessários para que o
                      site funcione corretamente, como manutenção de sessão,
                      carregamento de páginas e preferências de idioma.
                    </li>
                    <li>
                      <strong>Dados técnicos de navegação:</strong> endereço IP,
                      tipo de navegador, resolução de ecrã, tempo de acesso às
                      páginas — utilizados apenas para fins de segurança e
                  ...
                  <div className="mt-3 p-2 rounded-lg bg-amber-50/50 border border-amber-200/50">
                    <span className="text-[10px] sm:text-xs text-text-accent leading-relaxed block">
                      ...
                      upload de documentos, nem receber comunicações de marketing
                      ou publicidade personalizada.
                    </span>
                  </div>
                </div>
              </div>

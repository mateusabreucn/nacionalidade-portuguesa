  ...
  return (
    <div className="flex flex-col text-text-primary mx-auto text-center lg:text-left">
      <div className="font-josefin leading-tight">
        ...
        <h1 className="font-medium text-2xl sm:text-[2.6rem] lg:text-[2.2rem] xl:text-[2.8rem] 2xl:text-[3.2rem] 3xl:text-[4rem] 4xl:text-7xl">
      ...
      <button
        className="
          bg-btn-light rounded px-8 xl:px-10 py-1.5 lg:py-2 3xl:px-12 3xl:py-4 4xl:px-16 4xl:py-6
          mt-4 sm:mt-6 md:mt-8 xl:mt-10
          w-fit border border-border-default

...
export default function PopUpWhatsApp() {
  ...
  return (
    <a
      ...
      className={`fixed bottom-4 right-4 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-card-branco p-3 img-shadow cursor-pointer transition-all duration-300 ease-in-out hover:scale-110 sm:h-16 sm:w-16 lg:h-20 lg:w-20 xl:h-24 xl:w-24 ${
        isVisible
